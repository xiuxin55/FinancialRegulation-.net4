...
namespace DataProgram
{
    public class LoginVM:NotificationObject
    {
        ...
        public System.Windows.Controls.PasswordBox passwordbox { get; set; }
        ...
        private bool Check()
        {
            ui.UserPwd = passwordbox.Password;
            //登录信息
            if (ui.UserCode == null)
            {
            ...
            try
            {
                ...
                if (Check())
                {
                    ...
                    if (CheckLogin())
                    {
                        ...
                        DayBalaceSynWindow win = new DataProgram.DayBalaceSynWindow();
                        win.Show();
                        if (Loginwindow!=null)
                        {
                            Loginwindow.Hide();
